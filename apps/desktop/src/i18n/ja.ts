...
export const ja = defineLocale({
  ...
  artifacts: {
    projectLibrary: 'プロジェクトのアーティファクト',
    allProjects: 'すべてのプロジェクト',
    allProjectsHint: '展開したプロジェクトの最近のアーティファクトだけを読み込みます。',
    noProjects: 'プロジェクトがありません',
    noProjectsDesc: 'プロジェクトを追加または開くと、生成物がプロジェクト別に整理されます。',
    openSidebar: 'サイドバーで開く',
    openProject: '開く',
    paneTitle: 'アーティファクト',
    projectPaneTitle: project => `${project} · アーティファクト`,
    indexingProject: project => `${project || 'プロジェクト'}のアーティファクトを索引中`,
    indexingContext: '関連するアーティファクトを読み込み中',
    sessionCount: count => `${count} セッション`,
    loadMoreSessions: (loaded, total) => `さらに読み込む（${loaded}/${total} セッション）`,
    noArtifactsInProject: 'このプロジェクトに一致するアーティファクトはありません。',
    noContextArtifactsDesc: 'この会話とプロジェクトの生成物がここに表示されます。',
    noConversationArtifacts: 'この会話にはまだアーティファクトがありません。',
    noRecentProjectArtifacts: '最近のプロジェクトセッションにはアーティファクトがありません。',
    thisConversation: 'この会話',
    recentInProject: 'プロジェクトの最近',
    viewAll: 'プロジェクトのすべてを表示',
    search: 'アーティファクトを検索...',
    refresh: 'アーティファクトを更新',
