...
export const ar = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      createCustomTheme: 'إنشاء سمة مخصصة',
      editCustomTheme: 'تحرير السمة المخصصة',
      customThemeDesc: 'حرّر لوحتي الألوان الفاتحة والداكنة. تظهر التغييرات مباشرة ولا تُحفظ إلا عند الضغط على حفظ.',
      customThemeName: 'اسم السمة',
      customAccent: 'لون التمييز',
      customBackground: 'الخلفية',
      customForeground: 'المقدمة',
      customUiFont: 'خط الواجهة',
      customCodeFont: 'خط التعليمات البرمجية',
      customSidebar: 'شريط جانبي شفاف',
      customContrast: 'التباين',
      customInvalidColor: 'استخدم لونًا سداسيًا صالحًا مثل #0053FD.',
      customReset: 'إعادة ضبط',
      pet: {
        title: 'حيوان أليف',
        intro:
