...
export const ar = defineLocale({
  ...
  artifacts: {
    projectLibrary: 'عناصر المشروع',
    allProjects: 'كل المشاريع',
    allProjectsHint: 'وسّع مشروعًا لتحميل عناصره الحديثة فقط.',
    noProjects: 'لا توجد مشاريع',
    noProjectsDesc: 'أضف مشروعًا أو افتحه لتنظيم المخرجات حسب المشروع.',
    openSidebar: 'فتح في الشريط الجانبي',
    openProject: 'فتح',
    paneTitle: 'العناصر',
    projectPaneTitle: project => `عناصر ${project}`,
    indexingProject: project => `جارٍ فهرسة عناصر ${project || 'المشروع'}`,
    indexingContext: 'جارٍ تحميل العناصر ذات الصلة',
    sessionCount: count => `${count} جلسة`,
    loadMoreSessions: (loaded, total) => `تحميل المزيد (${loaded}/${total} جلسة)`,
    noArtifactsInProject: 'لا توجد عناصر مطابقة في هذا المشروع.',
    noContextArtifactsDesc: 'ستظهر مخرجات هذه المحادثة والمشروع هنا.',
    noConversationArtifacts: 'لا توجد عناصر في هذه المحادثة.',
    noRecentProjectArtifacts: 'لا توجد عناصر في جلسات المشروع الحديثة.',
    thisConversation: 'هذه المحادثة',
    recentInProject: 'الأحدث في المشروع',
    viewAll: 'عرض كل عناصر المشروع',
    search: 'بحث',
    refresh: 'تحديث',
    refreshing: 'جار التحديث...',
