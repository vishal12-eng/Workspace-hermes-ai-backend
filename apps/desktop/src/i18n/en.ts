...
export const en: Translations = {
  ...
  artifacts: {
    projectLibrary: 'Project artifacts',
    allProjects: 'All projects',
    allProjectsHint: 'Expand a project to load its recent artifacts.',
    noProjects: 'No projects',
    noProjectsDesc: 'Add or open a project to organize its generated outputs here.',
    openSidebar: 'Open sidebar',
    openProject: 'Open',
    paneTitle: 'Artifacts',
    projectPaneTitle: project => `${project} artifacts`,
    indexingProject: project => `Indexing ${project || 'project'} artifacts`,
    indexingContext: 'Loading relevant artifacts',
    sessionCount: count => `${count} ${count === 1 ? 'session' : 'sessions'}`,
    loadMoreSessions: (loaded, total) => `Load more (${loaded}/${total} sessions)`,
    noArtifactsInProject: 'No matching artifacts in this project.',
    noContextArtifactsDesc: 'Outputs from this conversation and project will appear here.',
    noConversationArtifacts: 'No artifacts in this conversation.',
    noRecentProjectArtifacts: 'No artifacts in recent project sessions.',
    thisConversation: 'This conversation',
    recentInProject: 'Recent in project',
    viewAll: 'View all project artifacts',
