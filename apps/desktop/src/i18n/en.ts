...
export const en: Translations = {
  ...
  settings: {
    ...
    appearance: {
      ...
      customThemeDesc: 'Edit the light and dark palettes. Changes preview live and are saved only when you choose Save.',
      customThemeName: 'Theme name',
      customAccent: 'Accent',
      customBackground: 'Background',
      customForeground: 'Foreground',
      customUiFont: 'UI font',
      customCodeFont: 'Code font',
      customSidebar: 'Translucent sidebar',
      customContrast: 'Contrast',
      customInvalidColor: 'Use a valid hex color, such as #0053FD.',
      customReset: 'Reset',
      pet: {
        title: 'Pet',
        intro:
