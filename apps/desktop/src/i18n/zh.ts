...
export const zh: Translations = {
  ...
  artifacts: {
    projectLibrary: '项目产物',
    allProjects: '全部项目',
    allProjectsHint: '展开项目后才会加载它最近的产物。',
    noProjects: '暂无项目',
    noProjectsDesc: '添加或打开项目后，生成的内容会在这里按项目整理。',
    openSidebar: '在侧栏打开',
    openProject: '打开',
    paneTitle: '产物',
    projectPaneTitle: project => `${project} · 产物`,
    indexingProject: project => `正在索引${project || '项目'}的产物`,
    indexingContext: '正在加载相关产物',
    sessionCount: count => `${count} 个会话`,
    loadMoreSessions: (loaded, total) => `加载更多（${loaded}/${total} 个会话）`,
    noArtifactsInProject: '这个项目中没有匹配的产物。',
    noContextArtifactsDesc: '当前对话和项目生成的内容会显示在这里。',
    noConversationArtifacts: '本次对话暂时没有产物。',
    noRecentProjectArtifacts: '项目最近的会话暂时没有产物。',
    thisConversation: '本次对话',
    recentInProject: '项目最近',
    viewAll: '查看项目全部产物',
    search: '搜索产物…',
    refresh: '刷新产物',
    refreshing: '正在刷新产物',
